...
dtls=(yellow+"\t\t𝐂𝐫𝐞𝐚𝐭𝐞𝐝 𝐁𝐲: ✌😈  ERROR-404ᶰ    ♧👻 ")

note=(red+"ɴᴏᴛᴇ: ɪ ᴡᴏɴᴛ ʙᴇ ʀᴇꜱᴘᴏɴꜱɪʙʟᴇ ꜰᴏ ᴀɴʏ ɪʟʟɪɢᴀʟ ᴀᴄᴛɪᴠɪᴛᴇꜱ.")
...
number=str(input(red+"[➙] 𝐄𝐧𝐭𝐞𝐫 𝐘𝐨𝐮𝐫 𝐍𝐮𝐦𝐛𝐞𝐫 : "))
amount=int(input(cyan+"[➙] 𝐄𝐧𝐭𝐞𝐫 𝐓𝐡𝐞 𝐀𝐦𝐨𝐮𝐧𝐭 : "))
...
print('					')
print(cyan+'\t\tThanks For Using EɾɾσɾX')
